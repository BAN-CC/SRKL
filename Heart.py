...
HEART_COLOR = "#FF69B4"  # 爱心颜色改为深粉红色
TEXT_COLOR = "#FFFF00"  # 字体颜色改为黄色
BACKGROUND_COLOR = "#FFCCCC"  # 背景颜色改为红色
...
class Heart:
    ...
    def render(self, render_canvas, render_frame):
        ...
        render_canvas.create_text(CANVAS_CENTER_X, CANVAS_CENTER_Y, text="生日快乐", fill=TEXT_COLOR, font=("Helvetica", 24, "bold"))

def draw(main: Tk, render_canvas: Canvas, render_heart: Heart, render_frame=0):
    render_heart.render(render_canvas, render_frame)
    main.after(50, draw, main, render_canvas, render_heart, render_frame + 1)  # 减少绘制间隔以提高流畅度
